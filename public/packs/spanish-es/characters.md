...
## Season 2 (Weeks 13–18) — where everyone goes next

*The extension from B1 to the C1 gateway. Same world, one year on. The season-1 four
continue exactly where day 84 left them; two new voices carry the C1-gateway themes
(professional Spanish + regional-accent exposure). Any character named in a season-2
dialogue must be in the manifest `cast` — that now includes **Marta** and **Dani**.*

### Where the season-1 four are now

- **Lucía** — still in Madrid (Lavapiés), still your main narrator and steady thread. In season 2 she's the one who's proud of how far you've come; she anchors the day-90 *sobremesa* debate and is present at the finale. Same markers (*mira, vale, o sea, en plan, tía*).
- **Rafa** — still in Madrid, still the bar/*cotilleo* partner and your storytelling foil. In season 2 he's the vehicle for **regrets and roads not taken** (day 97: *si no me hubiera quedado en el mismo curro…*) and for **irony/slang heard honestly** (W17). Same dry, blunt-then-softens voice; mild swearing (*joder, jolín*) — the on-ramp to the honest red-tier day (115).
- **Sofía** — **stays in Valencia the entire season** (she moved day 69; never silently back in Madrid). Happier, settled. Calls in from Valencia on the day-111 pivot and comes up to Madrid for the day-125/126 finale. *"Hace un año fui yo, ahora te toca a ti."*
- **Nacho** — still on Madrid's edge with partner + kid. Season-2 use is lighter: the measured *pueblo* voice for a layered-tense childhood/trajectory beat if needed, and a finale presence. Still jabs Madrid; still *distinción*.
...
- **Immersion (review) days:** 90 (*sobremesa* debate, Marta joins the group), 97 (Rafa & You — regrets/roads not taken), 104 (Marta's career trajectory — professional set-up), **111 (THE life event)**, 118 (irony/slang/register in the wild; **Dani** appears), 125 (finale — whole crew, Sofía up from Valencia, Dani cameo).
- **THE season-2 life event — day 111 (mirrors day 69):** **the learner gets a firm job offer in Spain and decides to stay and build a life here.** Told as a layered-tense immersion: the friends react — Rafa teases, Lucía is proud, Sofía calls from Valencia (*"hace un año fui yo, ahora te toca a ti"*). This is the emotional pivot of season 2, structurally parallel to Sofía's day-69 move. The job then gets *pursued* across W18 (the *entrevista*, the *email formal*, the *empadronamiento*).
- **Finale — day 126:** everyone one year on; the learner delivers the definitive C1-gateway self-portrait (layered tenses, register-switching, a wink of irony, a letter to their season-1 self, Spanish farewells).
- **Continuity rules:** Sofía is in Valencia for all of S2. Marta first appears day 90; Dani first appears day 118. Neither existed in the learner's life before those days — don't back-reference them into season 1.

### Mi historia — season-2 rows (13–18, cumulative on rows 1–12)

| Wk | Capstone day | New "Mi historia" layer |
|----|------|------|
| 13 | 91  | + a **nuanced opinion** with connectors (*no es que sea…, sino que…; por un lado… por otro; en el fondo…*) |
| 14 | 98  | + a **hypothetical / a regret** (*si hubiera sabido…, habría…; si pudiera volver atrás…*) |
| 15 | 105 | + a **professional self-presentation** — your trajectory (*llevo X años…, me hice…, me he ido especializando…*) |
| 16 | 112 | + **layered-tense storytelling** — one pivotal episode in 3–4 past tenses (*había… cuando…, y desde entonces…*) |
| 17 | 119 | + **irony & register-switching** — the same beat said straight, ironically, and to a boss (*usted*) vs friends (*vosotros*) |
